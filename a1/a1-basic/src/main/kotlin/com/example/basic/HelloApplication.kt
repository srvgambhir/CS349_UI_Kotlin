...
class HelloApplication : Application() {
    ...
    override fun start(stage: Stage) {
        ...
        // Initial notes
        val note1 = Note("This is a note.")

        // Set note2 to archived
        val note2 = Note("This is another note.")
        note2.listText.archived_checkBox.isSelected = true

        val note3 = Note("Oh wow, this is yet another note.")

        val note4 = Note("Would you believe it! This is a new note.")
