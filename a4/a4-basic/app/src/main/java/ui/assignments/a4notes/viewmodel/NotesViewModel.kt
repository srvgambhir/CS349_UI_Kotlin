...
class NotesViewModel : ViewModel() {
    ...
    /**
     * update viewArchived value and call update function in Model
     * *****************************************************************************************************************
     */
    fun setViewArchived(show: Boolean) {
        viewArchived.value = show
        model.updateArchivedNotes()
    }

    /**
     * Functions to call matched functions in model
     * i.e. take request from fragments, and pass onto Model
     */
    ...
    /**
     * Id of note being updates -> helps to send information to Edit fragment on note box click
     */
    var editNoteId:Int = -1
}